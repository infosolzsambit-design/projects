...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // NOTE: no database-level foreign keys anywhere in this project.
        // Relationships (including the cascade-on-delete Spatie normally
        // gets from FKs) are enforced in application code instead — see
        // App\Models\Role/Permission for force-delete pivot cleanup.
