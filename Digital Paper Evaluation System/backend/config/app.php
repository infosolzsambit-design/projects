...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Shared secret every /api/v1 request must present via the X-API-KEY
    | header (checked by App\Http\Middleware\ApiKeyAuth) before Sanctum
    | authentication or permission checks are evaluated.
    |
    */
