        ...
        <table class="w-full min-w-[560px] text-left">
          <thead>
            <tr class="bg-subject-header text-white text-[13px] font-medium">
              ...
              <th class="px-4 py-3.5 font-medium" v-if="authStore.can('permission-group-status-change')">Status</th>
              <th class="px-4 py-3.5 font-medium text-center rounded-tr-2xl" v-if="authStore.can('permission-group-edit') || authStore.can('permission-group-delete')">Action</th>
            </tr>
          </thead>
          <tbody class="bg-white">
            ...
            >
              ...
              <td class="px-4 py-3.5 font-semibold">{{ group.name }}</td>
              ...
              <td v-if="authStore.can('permission-group-status-change')" class="px-4 py-3.5" @click.stop>
                <button
                  type="button"
                  role="switch"
                  ...
                  :class="group.status ? 'bg-btn-gradient text-white justify-start pl-3 pr-7' : 'bg-gray-300 text-gray-600 justify-end pl-7 pr-3'"
                ...
                >
                  ...
                  <span
                    ...
                    :class="group.status ? 'translate-x-16' : 'translate-x-0'"
                  ></span>
                </button>
              </td>
              <td v-if="authStore.can('permission-group-edit') || authStore.can('permission-group-delete')" class="px-4 py-3.5 text-center relative" @click.stop>
                <RowActionMenu>
