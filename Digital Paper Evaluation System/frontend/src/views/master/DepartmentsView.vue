        ...
        <table class="w-full min-w-[620px] text-left">
          <thead>
            <tr class="bg-subject-header text-white text-[12px] font-medium">
              ...
              <th class="px-4 py-1.5 font-medium" v-if="authStore.can('department-status-change')">Status</th>
              <th class="px-4 py-1.5 font-medium text-center rounded-tr-2xl" v-if="authStore.can('department-edit') || authStore.can('department-delete')">Action</th>
            </tr>
          </thead>
          <tbody class="bg-white">
            ...
            >
              ...
              <td class="px-4 py-1 font-semibold">{{ department.name }}</td>
              <td class="px-4 py-1">{{ department.code || '—' }}</td>
              <td v-if="authStore.can('department-status-change')" class="px-4 py-1" @click.stop>
                <button
                  type="button"
                  role="switch"
                  ...
                  :class="department.status ? 'bg-btn-gradient text-white justify-start pl-2.5 pr-6' : 'bg-gray-300 text-gray-600 justify-end pl-6 pr-2.5'"
                ...
                >
                  ...
                  <span
                    ...
                    :class="department.status ? 'translate-x-[56px]' : 'translate-x-0'"
                  ></span>
                </button>
              </td>
              <td v-if="authStore.can('department-edit') || authStore.can('department-delete')" class="px-4 py-1 text-center relative" @click.stop>
                <RowActionMenu>
