            ...
            >
              ...
              <td v-if="authStore.can('program-status-change')" class="px-4 py-1" @click.stop>
                <button
                  ...
                  :class="program.status ? 'bg-btn-gradient text-white justify-start pl-2.5 pr-6' : 'bg-gray-300 text-gray-600 justify-end pl-6 pr-2.5'"
                ...
                >
                  ...
                  <span
                    ...
                    :class="program.status ? 'translate-x-[56px]' : 'translate-x-0'"
                  ></span>
                </button>
              </td>
              <td v-if="authStore.can('program-edit') || authStore.can('program-delete')" class="px-4 py-1 text-center relative" @click.stop>
                <RowActionMenu>
